...
export default function BlogPostCard(props: { postData: Post }) {
    ...
    return (
        <div
            className={cn('flex gap-4 cursor-pointer hover:bg-yellow/20 duration-100 transition-all bg-yellow/10 p-8 rounded-md shadow-md backdrop-blur-sm self-stretch', {
